    ...
    return (
        <Row style={{ marginBottom: "10%" }}>
                ...
                <Col md={7}>
                    ...
                    <p className="projectSummary">Full-stack Visa Service Agency website</p>
                    <small>
                        <i>April, 2021</i>
                    </small>
                    <br />
                    <br />
                    <p>
                        This is a Visa Agency Website. Registered visa appliers
                        can pay with their credit cards for booking a visa and
                    ...
                    <p><b>Tools: </b></p>
                    <p><b>Front-end: </b>: React.js, React Router,
                    React-Bootstrap, React Hook Form, Bootstrap, Stripe Payment
                    Method, Firebase, Firebase Authentication system.</p>
                    <p><b>Back-end: </b>: Node.js, Express.js, MongoDB, Heroku.</p>
                    <a
